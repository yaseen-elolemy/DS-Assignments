...
template<typename T>
void StatisticalCalculation<T>::ReadDataFromFile(const string& filename, int testCaseNumber) {
...
void StatisticalCalculation<T>::StatisticsMenue() {
    ReadDataFromFile("Problem5.txt", size);
	cout << "Array Elements: ";
	displayArray();
    int choice;
    do {
...
int main() {
        ...
        cin >> type;
        if (type == "1") {
            StatisticalCalculation<int> obj(1);
            obj.StatisticsMenue();
        }
        else if (type == "2") {
            StatisticalCalculation<float> obj(2);
            obj.StatisticsMenue();
        }
        else if (type == "3") {
            StatisticalCalculation<double> obj(3);
            obj.StatisticsMenue();
        }
        else {
            cout << "Invalid type.\n";
